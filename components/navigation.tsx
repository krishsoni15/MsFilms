    ...
    <>
      ...
      >
        <div className="flex items-center justify-between w-full mx-auto">
            ...
            <AnimatePresence>
              {connectOpen && (
                <motion.div
                  ...
                  animate="visible"
                  exit="exit"
                  className="absolute right-0 top-full mt-3 min-w-[300px] z-50 rounded-2xl border border-white/[0.08] bg-[#020813]/90 backdrop-blur-3xl shadow-[0_32px_64px_-16px_rgba(0,0,0,0.9),0_0_40px_rgba(197,168,128,0.04),inset_0_1px_1px_rgba(255,255,255,0.06)] p-2.5 flex flex-col gap-1 overflow-hidden"
                >
                  {connectLinks.map((item) => (
                    <motion.a
                      ...
                      className="group flex items-center justify-between p-2.5 rounded-xl transition-all duration-300 hover:bg-white/[0.03] active:scale-[0.98]"
                    >
                      <div className="flex items-center gap-3.5">
                        <div className="p-2.5 rounded-lg bg-white/[0.02] border border-white/[0.04] text-white/50 transition-all duration-300 group-hover:bg-gold/10 group-hover:border-gold/25 group-hover:text-gold group-hover:scale-105">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[9px] tracking-wide text-white/35 group-hover:text-white/55 transition-colors duration-300 mt-0.5 max-w-[170px] truncate">
                            {item.subtitle}
                          </span>
                        </div>
                      </div>
          ...
          {/* ─── Mobile Hamburger ─── */}
          <button
            className="lg:hidden z-50 relative w-10 h-10 flex flex-col justify-center items-center rounded-full border border-white/10 bg-white/[0.03] backdrop-blur-md hover:bg-white/10 active:scale-95 transition-all duration-300"
            onClick={() => setMobileOpen(!mobileOpen)}
            aria-label="Toggle Menu"
          >
            <span
              className={`block w-5 h-[1.5px] bg-white transition-all duration-300 ${mobileOpen ? "rotate-45 translate-y-[1.5px]" : "mb-1.5"
                }`}
            />
            <span
              className={`block w-5 h-[1.5px] bg-white transition-all duration-300 ${mobileOpen ? "-rotate-45 -translate-y-[1.5px]" : ""
                }`}
            />
          </button>
        </div>
      ...
      <AnimatePresence>
        ...
        {mobileOpen && (
          <motion.div
            ...
            style={{ zIndex: 9995 }}
            className="fixed top-0 right-0 bottom-0 h-full w-full sm:w-[440px] md:w-[480px] bg-gradient-to-b from-[#030914] via-[#050d1a] to-[#0e0a05] border-l border-gold/15 backdrop-blur-2xl shadow-[0_0_60px_rgba(0,0,0,0.85)] p-0 flex flex-col overflow-hidden"
          >
            ...
            <motion.div
              ...
              className="relative z-10 px-8 sm:px-12 pb-10 border-t border-white/[0.05] pt-8 space-y-6"
            >
              {/* Connect Label */}
              <p className="text-[9px] tracking-[0.2em] uppercase text-white/30 font-sans font-medium">
                Connect With Us
              </p>
              ...
              <div className="flex flex-wrap gap-2.5">
                {connectLinks.map((item) => (
                  <a
                    ...
                    onClick={() => setMobileOpen(false)}
                    className="group flex items-center gap-2.5 px-4.5 py-3 rounded-full border border-white/10 bg-white/[0.03] text-white/70 hover:text-gold-light hover:border-gold/45 hover:bg-gold/[0.06] transition-all duration-300 text-[10px] tracking-[0.15em] uppercase font-sans font-medium active:scale-[0.97]"
                  >
              ...
              <div className="flex items-center justify-between border-t border-white/[0.05] pt-6">
                ...
                />
                <p className="text-white/20 text-[9px] tracking-[0.15em] uppercase font-sans font-medium">
