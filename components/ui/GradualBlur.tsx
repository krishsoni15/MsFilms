...
export interface GradualBlurProps {
  ...
  [key: string]: any; // Allow responsive mobile/tablet/desktop keys like mobileHeight
}
...
function GradualBlur(props: GradualBlurProps) {
  ...
  const containerStyle = useMemo(() => {
    ...
    if (isVertical) {
      ...
      baseStyle[config.position as "top" | "bottom" | "left" | "right"] = 0;
      baseStyle.left = 0;
      baseStyle.right = 0;
...
const GradualBlurMemo = React.memo(GradualBlur) as unknown as React.MemoExoticComponent<
  React.ForwardRefExoticComponent<GradualBlurProps & React.RefAttributes<HTMLDivElement>>
> & {
